...
linearRegressionAndPlot(x1, y1, "Linear regression predictions (1)")

# test 2
x2 = np.array([-31, -11, 9, 29, 49, 69, 89, 109])
y2 = np.array([-33, -15, 10, 30, 45, 67, 92, 113])

linearRegressionAndPlot(x2, y2, "Linear regression predictions (2)")

# test 3
x3 = np.array([15, 78, 157, 199, 202, 203, 250, 288])
y3 = np.array([20, 60, 130, 180, 200, 210, 30, 250])

linearRegressionAndPlot(x3, y3, "Linear regression predictions (3)")
